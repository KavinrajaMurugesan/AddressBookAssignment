...
namespace AddressBookApi.Controllers
{
    ...
    public class AccountController:ControllerBase
    {
        ...
        /// <returns>IActionResult list of user</returns>
        
        [HttpGet]
        [Authorize]
        public IActionResult Get([FromQuery] Pagination Page)
        {
        ...
        /// <summary>
        /// This GetById Method is to get the user by userid
        /// </summary>
        /// <param name="id"></param>
        /// <returns>IActionResult of UserDetailsDto</returns>
        ...
        /// <summary>
        /// This Method is used to softdelete the user
        /// </summary>
        /// <param name="id"></param>
        /// <returns>IActionResult</returns>
        [HttpDelete]
        ...
        /// <summary>
        /// This method is used to Update the update the pre-existing userdetails
        /// </summary>
        /// <param name="user"></param>
        /// <param name="id"></param>
        /// <returns>IActionResult of UserDetailsDto</returns>
        ...
        /// <summary>
        /// To Get the UserCount in the database
        /// </summary>
        /// <returns>IActionResult of Count of the User</returns>
        [HttpGet]
        [Route("count")]
        [Authorize]
