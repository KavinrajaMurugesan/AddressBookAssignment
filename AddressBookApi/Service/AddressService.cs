...
namespace AddressBookApi.Service
{
    public class AddressService : IAddressService
    {
        ...
        private bool IsChecking(LoginDto user)
        {
            try
            {
                Log.Information("IsChecking is triggered");
        ...
        public LoginResponsesDto GenerateToken(LoginDto user)
        {
            try
            {
                Log.Information("Generate token Triggered");
        ...
        {
           Log.Information("EmailValidate in service is Triggered");
            try
            {
            ...
            {
                Log.Information("Exception Occurred", e);
                throw e;
            }
        }
        ...
        {
            Log.Information("AddUser in service is triggerred");
            try
            {
        ...
        {
            Log.Information("GetAllUsers in service is triggered");
            try
            {
        ...
        {
            Log.Information("GetById method in service is triggered");
            try
            {
        ...
        {
            Log.Information("DeleteUser in service is triggered");
            try
            {
        ...
        {
            Log.Information("CountUser methos in service is triggered");
            try
            {
        ...
        {
            Log.Information("GetMetadata is triggered");
            try
            {
        ...
        {
            Log.Information("UploadFile method in service has triggered");
            try
            {
        ...
        {
            Log.Information("FileDownload is triggered");
            try
            {
        ...
        {
            Log.Information("ValidateUser in service is triggered");
            try
            {
